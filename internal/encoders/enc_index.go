...
type encoderFactory = func(size size.Size, frameRate int) (Encoder, error)
...
func (*EncoderService) NewEncoder(codec VideoCodec, size size.Size, frameRate int) (Encoder, error) {
